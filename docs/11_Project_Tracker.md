...
|---|---|---|---|---|---|
| Sprint 12: AI Assistant interface | Introduce the AI Assistant as a contextual right-side drawer. | Assistant drawer, prompt input, prompt suggestions, context display, loading/error states. | Sprint 6, Sprint 9 context, Sprint 11 report context, AI architecture. | Users can open, use, and close the drawer without disrupting core workflows. | Drawer interaction tests, focus/keyboard tests, context-boundary review. |
| Sprint 13: Authentication and user accounts | Add user account access for SaaS foundation. | Signup, login, forgot password, sessions, protected routes, profile foundation. | Auth provider decision, security standards, app shell. | Users can create accounts, log in, recover access, and reach protected app pages. | Auth functional tests, protected route tests, security review. |
| Sprint 14: Database and persistent projects | Persist projects, uploads, analyses, and reports. | Database schema, migrations, project records, analysis records, report metadata. | Sprint 13, database decision, storage strategy. | Users can reopen projects, analyses, and reports across sessions. | Migration tests, CRUD tests, persistence regression, authorization checks. |
| Sprint 15: Team workspaces and permissions | Add workspace collaboration foundations. | Workspace model, member list, invites, basic roles, permission checks, workspace settings foundation. | Sprint 13, Sprint 14, security standards. | Workspace owners can invite members and basic permissions are enforced. | Invite tests, role tests, workspace isolation tests, access-denied tests. |
...
| Reports library and viewer | P1 | Done | Sprint 11 | App shell, local workspace state, report URLs from analysis output | M | Frontend | Generated reports are stored as local report records, searchable/filterable in the Reports Library, open in a report viewer, and appear on dashboard and project report surfaces. | [04_Wireframes.md](04_Wireframes.md), [16_Test_Plan.md](16_Test_Plan.md) | TBD | Frontend build, UI smoke, responsive, MVP regression |
...
| Reports Library UI | P1 | Done | Sprint 11 | App shell, local workspace state, completed analysis report URLs | M | Frontend | Reports page supports search, project/status filters, sorting, cards, empty state, download actions, and report viewer without backend persistence. | [04_Wireframes.md](04_Wireframes.md), [05_Design_System.md](05_Design_System.md) | TBD | Frontend build, UI smoke, responsive checks, report workflow regression |
...
| Reports library | P1 | Done | Sprint 11 | Local workspace state, projects, generated PDF/CSV URLs | M | Frontend | Users can revisit generated reports in the local MVP through searchable, filterable, sortable report records. | [02_Application_Sitemap.md](02_Application_Sitemap.md), [04_Wireframes.md](04_Wireframes.md) | TBD | Functional, responsive, localStorage |
| Report viewer | P1 | Done | Sprint 11 | Reports library, analysis summary data | M | Frontend | Users can open report details with executive summary, themes, sentiment, recommended actions, dataset overview, and download links. | [04_Wireframes.md](04_Wireframes.md) | TBD | UI, download regression |
...
| Feature Name | Priority | Status | Sprint | Dependencies | Estimated Effort | Owner | Definition of Done | Related Documentation | Related GitHub Issue | Testing Required |
|---|---|---|---|---|---|---|---|---|---|---|
| Assistant drawer | P2 | Planned | Sprint 12 | Stored analysis and report context | L | Full Stack/AI | Assistant opens as right-side drawer and answers within current context. | [04_Wireframes.md](04_Wireframes.md) | TBD | AI, security, UI |
...
| 1.6 | 2026-07-05 | Codex | Recorded Sprint 11 Reports Library and Report Viewer completion, local report records, and revised Sprint 12 AI Assistant focus. |
